...
public class JedisUtil {
    ...
    public long expireAt(String key, int unixTimestamp) {
        ...
        try (Jedis jedis = this.jedisPool.getResource()) {
            ...
            logger.error("expireAt error[key={}, unixTimestamp={}]", key, unixTimestamp, ex);
        }
        return 0L;
    }
     ...
     * @param key
     * @param value
     * @param senconds 过期时间/秒
     * @return boolean true/false
     */
    public boolean setnx(String key, String value, int senconds) {
        try (Jedis jedis = this.jedisPool.getResource()) {
    ...
    public boolean rpush(String key, String... value) {
        ...
        try (Jedis jedis = this.jedisPool.getResource()) {
            ...
            logger.error("rpush error.", ex);
        }
        return false;
    }

    public boolean rpush(String key, int seconds, String... value) {
    ...
    public boolean sadd(String key, int seconds, String member) {
    ...
    public Set<String> zrangeByScore(String key, long startScore, long endScore, boolean orderByDesc) {
        try (Jedis jedis = this.jedisPool.getResource()) {
            ...
            logger.error("zrangeByScore error.", ex);
        }
        return null;
    }
    ...
    public List<List<String>> getAllLikeKey(String key) {
        ...
        try (Jedis jedis = this.jedisPool.getResource()) {
            ...
            logger.error("getAllLikeKey error.", ex);
        }
        return list;
    }
     ...
     * @param <T>
     */
    public <T> void addObject(String name, String objectId, int seconds, T t) {
        try (Jedis jedis = this.jedisPool.getResource()) {
